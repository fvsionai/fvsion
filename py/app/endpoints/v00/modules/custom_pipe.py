# Adapted from https://github.com/huggingface/diffusers/pull/241
...
# preprocess adapted from https://github.com/replicate/cog-stable-diffusion
...
class FvsionPipeline(DiffusionPipeline):
    """
    ...
    def __call__(
        ...
        if width % 64 != 0 or height % 64 != 0:
            raise ValueError("Width and height must both be divisible by 64")
